...
ServiceNix := [].{
	...
	render_module = |name, secrets, restart| {
		...
		# sops-nix restarts the service after replacing a decrypted secret so the
		# process cannot continue using stale credentials.
		...
		# systemd LoadCredential provides each decrypted runtime file in the service's
		# credential directory. This keeps plaintext out of the generated module and
		# process environment.
