...
StdPlugin := [].{
	...
	commands = [BuildCommand.command, DeployCommand.command, ShellCommand.command, TaskCommand.command, UpdateCommand.command, WorkflowCommand.command]

	backends : List(PluginApi.Backend)
	backends = [NixBackend.backend]

	implementations : List(PluginApi.Implementation)
	implementations = [BuildNix.implementation, DeployNix.implementation, ShellNix.implementation, TaskNix.implementation, UpdateNix.implementation, WorkflowNix.implementation]
