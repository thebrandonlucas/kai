...
custom_dependencies = {
	plugin: RuntimeBundle.custom_dependencies.plugin.concat(StdBundle.custom_dependencies.plugin),
	commands: RuntimeBundle.custom_dependencies.commands.concat(StdBundle.custom_dependencies.commands),
	backends: RuntimeBundle.custom_dependencies.backends.concat(StdBundle.custom_dependencies.backends),
	implementations: RuntimeBundle.custom_dependencies.implementations.concat(StdBundle.custom_dependencies.implementations),
}
